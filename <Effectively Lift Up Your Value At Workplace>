...
- How to negotiate salary for new job?
  - Three cautions and two don'ts
    - Be careful to switch to a job if it's not a new opportunities
    - Be careful to switch job when you don't have a good performance
    - Be careful to switch to a job if you are offered an incomprehensible high salary
    - Don't switch to a totally unfamiliar field
    - Don't switch to a down-tending industry
  - Be honest to a headhunting
    - Leverage him to analze your dis/advantages for the new role
    - Ask the salary range beforehand
  - When asked about expected salary
    - Three thresholds:
      - Baseline: can't take range lower than this.
      - Market price: based on JD and salary info from other companies
      - Go-for-it price: the price that can make you say yes immediately
    - You shall always anwser a range bewtween Market and Go-for-it price, not a specific number.
    
- How to negotiate salary in a company?
  - Basic ideas
  ...
  - Detail steps
    ...
    - Right person
      - With your direct manager if it's not related to title change
      - Review your performance and then mention it
      - Bring up opportunities you discovered at work or team managing, and convience him that you can bring better value there
    - Correct sequence
      - Take bigger responsibility / opportunities first and then promotion comes after that
  - Different level
    - Promotion to mid-level: Good projects + people management skill
    - Promotion to high-level: Understand strategy + 
  - Evaluate the company
    - Is the industry growing?
    - Is the company among the top tier?
    - Is the manager good? or is the CEO good -- if the company is small.
    - Is the promoted co-worker sharing same value / vision / level of performance with you?
